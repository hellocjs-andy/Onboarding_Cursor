...
export const I18N: Record<string, Dict> = {
  ...
  en: {
    ...
    '中学/预科': 'Secondary / Pre-university',
    ...
    公司盈利: 'Company profit',
    家族资产: 'Family assets',
    '房地产投资/租金收入': 'Real estate investment / rental income',
    股票基金投资: 'Stocks & funds',
    出售公司股权: 'Sale of company equity',
    知识产权获利: 'Intellectual property income',
